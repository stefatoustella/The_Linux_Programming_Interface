...
# 22 "tlpi_hdr.h" 2
# 1 "error_functions.h" 1
# 18 "error_functions.h"
    void errMsg(const char *format, ...);
# 39 "error_functions.h"
    _Noreturn void errExit(const char *format, ...) ;
    _Noreturn void err_exit(const char *format, ...) ;
    _Noreturn void errExitEN(int errnum, const char *format, ...) ;
    _Noreturn void fatal(const char *format, ...) ;
    _Noreturn void usageErr(const char *format, ...) ;
    _Noreturn void cmdLineErr(const char *format, ...) ;
# 23 "tlpi_hdr.h" 2
# 4 "t_uname.c" 2
